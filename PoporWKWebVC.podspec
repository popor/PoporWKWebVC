...
Pod::Spec.new do |s|
  s.name             = 'PoporWKWebVC'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PoporWKWebVC.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/wangkq/PoporWKWebVC.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'PoporWKWebVC' => ['PoporWKWebVC/Assets/*.png']
  # }
